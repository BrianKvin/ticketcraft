  ...
  const accountTypes = [
    {
      ...
      description:
        "Create and manage events, sell tickets, and track analytics",
      features: [
                ...
                {accountTypes.map((type) => (
                  <Card
                    ...
                    className={`cursor-pointer transition-all hover:shadow-md ${
                      accountType === type.type ? "ring-2 ring-green-500" : ""
                    }`}
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="text-sm">
                      ...
                      <p className="text-blue-700">
                        ...
                        You'll receive an email confirmation once verified. All
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="text-sm">
                      ...
                      <p className="text-green-700">
                        ...
                        information. Payouts are processed automatically based
