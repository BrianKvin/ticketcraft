...
const Navbar = () => {
  ...
  const navItems = [
    ...
    { name: "EasyExchange", href: "/easyexchange" },
    { name: "White Label Ticketing", href: "/white-label" },
    ...
    { name: "For Brands & Resellers", href: "/brands" },
    {
      name: "Compare",
      href: "#",
      dropdown: [
        "Ticketsauce vs Eventbrite",
        "Ticketsauce vs eTix",
        "Ticketsauce vs Ticketleap",
        "Ticketsauce vs Tixr",
        "Ticketsauce vs SimpleTix",
        "Ticketsauce vs FareHarbor",
      ],
    },
  ...
  return (
    <>
      {/* Green bar */}
      <div className="bg-green-500 h-5 w-full"></div>

      {/* Navbar */}
      <nav
        className={`fixed top-5 left-0 right-0 z-[9999] transition-all duration-300 ease-in-out ${
          isScrolled
        ...
        {isMobileMenuOpen && (
          <div className="xl:hidden bg-white border-t border-gray-200 shadow-lg">
            <div className="max-w-7xl mx-auto px-4 py-2 max-h-96 overflow-y-auto">
              ...
              <Link
                to="/get-started"
                className="block mt-4 bg-green-500 hover:bg-green-600 text-white px-6 py-2 rounded-full font-semibold text-center"
                onClick={() => setIsMobileMenuOpen(false)}
              >
                Get Started
              </Link>
