  ...
  const agendaData = {
    day1: [
      {
        ...
        type: 'Keynote',
        duration: '60 min',
        description: 'Explore the technological trends that will shape the next decade.',
        registered: true
      },
      {
        id: 2,
      ...
      },
      {
        ...
        type: 'Break',
        duration: '30 min',
        description: 'Connect with fellow attendees and explore exhibitor booths.',
        registered: false
      },
      {
        id: 4,
        ...
        type: 'Panel',
        duration: '60 min',
        description: 'Industry leaders discuss the evolution of workplace dynamics.',
        registered: true
      },
      {
        id: 5,
      ...
      },
      {
        ...
        type: 'Workshop',
        duration: '90 min',
        description: 'Hands-on workshop on scaling startup operations effectively.',
        registered: true
      }
    ],
    day2: [
      ...
      },
      {
        ...
        type: 'Session',
        duration: '45 min',
        description: 'Explore emerging trends in UX design and user interaction.',
        registered: true
      },
      {
        id: 9,
        ...
        type: 'Session',
        duration: '45 min',
        description: 'Understanding modern cybersecurity challenges and solutions.',
        registered: false
      },
      {
        id: 10,
      ...
      },
      {
        ...
        type: 'Workshop',
        duration: '75 min',
        description: 'Learn to leverage data analytics for strategic decisions.',
        registered: true
      },
      {
        id: 12,
    ...
    day3: [
      ...
      },
      {
        ...
        type: 'Panel',
        duration: '60 min',
        description: 'VCs and angels discuss investment trends and opportunities.',
        registered: true
      },
      {
        id: 15,
      ...
      },
      {
        ...
        type: 'Keynote',
        duration: '60 min',
        description: 'Inspiring insights on industry transformation and innovation.',
        registered: true
      }
    ]
  };
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              ...
              {Object.values(agendaData)
                ...
                .map((session) => (
                  <div key={session.id} className="p-3 bg-green-50 rounded-lg">
                    <p className="font-medium text-green-800 text-sm">{session.title}</p>
                    <p className="text-green-600 text-xs mt-1">{session.time} - {session.location}</p>
                  </div>
                ))}
            </div>
          </CardContent>
      ...
      <div className="space-y-4">
        {agendaData[selectedDay].map((session) => (
          <Card key={session.id} className={`hover:shadow-md transition-shadow ${session.registered ? 'ring-2 ring-green-500 ring-opacity-20' : ''}`}>
      ...
      <div className="mt-8">
        <Card>
          <CardContent className="p-6 text-center">
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Export Your Schedule</h3>
            <p className="text-gray-600 mb-4">Download your personalized agenda to your calendar app</p>
